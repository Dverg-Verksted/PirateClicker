...
private:
    ...
    UPROPERTY(EditAnywhere,Category = "Health Settings",meta =(ClampMin ="0", ToolTip = "Здесь можно изменять максимальное хп актера с этим компонентом",
        EditCondition = "bEnableHealth", EditConditionHides))
    float MaxHealth = 100;
